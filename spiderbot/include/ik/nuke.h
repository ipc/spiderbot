 ...
 */
#define X_COXA      74  // MM between front and back legs /2
#define Y_COXA      73  // MM between front/back legs /2

/* Legs */
#define L_COXA      30  // MM distance from coxa servo to femur servo
#define L_FEMUR     54 // MM distance from femur servo to tibia servo
#define L_TIBIA     83 // MM distance from tibia servo to foot
