...
void doIK(){
    ...
    set_servo(RF_COXA, sol.coxa);
    set_servo(RF_FEMUR, sol.femur);
    set_servo(RF_TIBIA, sol.tibia);
    ...
    set_servo(RR_COXA, sol.coxa);
    set_servo(RR_FEMUR, sol.femur);
    set_servo(RR_TIBIA, sol.tibia);
    ...
    set_servo(LF_COXA, sol.coxa);
    set_servo(LF_FEMUR, sol.femur);
    set_servo(LF_TIBIA, sol.tibia);
    ...
    set_servo(LR_COXA, sol.coxa);
    set_servo(LR_FEMUR, sol.femur);
    set_servo(LR_TIBIA, sol.tibia); 
